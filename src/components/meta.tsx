...
export default function Meta() {
  return (
    <Head>
      ...
      <title>Builder Coobo</title>
      <meta property="og:title" content="Builder Coobo" key="title" />
      <meta
        name="description"
        content={`A statically generated blog example using Next.js and Builder.io.`}
      />
